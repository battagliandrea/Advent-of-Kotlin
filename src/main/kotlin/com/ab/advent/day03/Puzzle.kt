...
fun main() {
    ...
    println("Find the item type that appears in both compartments of each rucksack. What is the sum of the priorities of those item types?")
    println(answer1("puzzle_03_input.txt".readLines()))

    println("Find the item type that corresponds to the badges of each three-Elf group. What is the sum of the priorities of those item types")
    println(answer2("puzzle_03_input.txt".readLines()))
}

fun answer1(input: List<String>) = input.toGroup().priority
fun answer2(input: List<String>) = input.toChunkedGroup().priority
